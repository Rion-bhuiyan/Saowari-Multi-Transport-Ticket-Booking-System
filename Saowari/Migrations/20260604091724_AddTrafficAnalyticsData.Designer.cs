...
namespace Saowari.Migrations
{
    ...
    [Migration("20260604091724_AddTrafficAnalyticsData")]
    partial class AddTrafficAnalyticsData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saowari.Models.Entities.AdminNotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AdminUserId", "CompanyId")
                        .IsUnique();

                    b.ToTable("AdminNotificationPreference");
                });

            modelBuilder.Entity("Saowari.Models.Entities.Banner", b =>
                {
            ...
            modelBuilder.Entity("Saowari.Models.Entities.DepartureLocation", b =>
                {
                    b.Property<int>("DepartureLocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DepartureLocationID"));
                    ...
                    b.HasKey("DepartureLocationID");

                    b.HasIndex("LocationID");

                    b.HasIndex("ScheduleID");

                    b.ToTable("DepartureLocation");
                });
            ...
            modelBuilder.Entity("Saowari.Models.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Saowari.Models.Entities.ScheduleSeatClassPricing", b =>
                {
                    ...
                    b.HasIndex("ScheduleId", "SeatClassId")
                        .IsUnique();

                    b.ToTable("ScheduleSeatClassPricing");
                });
            ...
            modelBuilder.Entity("Saowari.Models.Entities.SeatPricing", b =>
                {
                    ...
                    b.HasIndex("VehicleId", "SeatClassId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Saowari.Models.Entities.SliderImage", b =>
                {
            ...
            modelBuilder.Entity("Saowari.Models.Entities.SupportMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Saowari.Models.Entities.SupportRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("UserEmailOrIP")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Saowari.Models.Entities.UserLoginHistory", b =>
                {
                    ...
                    b.Property<string>("TrafficChannel")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Saowari.Models.Entities.AdminNotificationPreference", b =>
                {
                    b.HasOne("Saowari.Models.Entities.User", "AdminUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Saowari.Models.Entities.DepartureLocation", b =>
                {
                    b.HasOne("Saowari.Models.Entities.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("Saowari.Models.Entities.Refund", b =>
                {
                    ...
                    b.HasOne("Saowari.Models.Entities.User", "UpdatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Saowari.Models.Entities.ScheduleChatMessage", b =>
                {
                    ...
                    b.HasOne("Saowari.Models.Entities.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Saowari.Models.Entities.ScheduleSeatClassPricing", b =>
                {
                    b.HasOne("Saowari.Models.Entities.Schedule", "Schedule")
                        .WithMany("ScheduleSeatClassPricings")
                        .HasForeignKey("ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Saowari.Models.Entities.SupportMessage", b =>
                {
                    b.HasOne("Saowari.Models.Entities.SupportRoom", "SupportRoom")
                    ...
                    b.Navigation("SupportRoom");
                });

            modelBuilder.Entity("Saowari.Models.Entities.SupportRoom", b =>
                {
                    b.HasOne("Saowari.Models.Entities.User", "AssignedAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("Saowari.Models.Entities.Schedule", b =>
                {
                    ...
                    b.Navigation("ScheduleSeatClassPricings");
